...
#_ANDROID_EABI=arm-linux-androideabi-4.8
    ...
    ./Configure shared no-zlib no-ssl2 no-ssl3 no-comp no-hw no-engine --openssldir=/usr/local/ssl/android-19/ $configure_platform $xCFLAGS
